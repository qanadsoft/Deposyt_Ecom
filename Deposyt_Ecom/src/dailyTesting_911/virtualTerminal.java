...
public class virtualTerminal extends Data {
	...
	String Product_Name = "OneTime Product - 911 " + UUID.randomUUID().toString().replace("-", "").substring(0, 4).toUpperCase(),
			...
			Country_Add = "Boardman, Oregon, 97818",ContactPhone1 = "(775) 986-5200",Price = "2", Value = "1",susbcriptionPrice = "3",Fileone = "file7.jpg",F_Name = "NineEleven", 
			L_Name = "Contact", Number = "(314) 237-5324", Street_Add = "Allen Court", country = "United States", ContactPhone2 = "(539) 321-3502",Account_Holder_Name = "DeposytCert", 
			Routing_Number = "490000018", Account_Number = "000123456789", EXP = "12/44", CVV = "123", Card_No = "4242424242424242", chars = "abcdefghijklmnopqrstuvwxyz",	
